...
#define AUDIO_FMT_NUSOUND		    (0x002F)		// NuSound with event (old type)
#define AUDIO_FMT_NUSOUND_NO_EVO  (0x0020)		// NuSound no EVO
#define AUDIO_FMT_NUSOUND_EVO		(0x0022)		// NuSound with EVO
...
#define AUDIO_FMT_NUONES			(0x0090)		// NuOneS without event
#define AUDIO_FMT_NUONES_E 		(0x0091) 		// NuOneS with event
#define AUDIO_FMT_NUONEEX			(0x00A0)		// NuOneEx without event , full encode range is 15 bits
#define AUDIO_FMT_NUONEEX_E 		(0x00A1) 		// NuOneEx with event , full encode range is 15 bits
#define AUDIO_FMT_NUONEEX_EVO 	(0x00A2) 		// NuOneEx with event only format , full encode range is 15 bits
#define AUDIO_FMT_EVO						(0x0008)		// Event Only Format
