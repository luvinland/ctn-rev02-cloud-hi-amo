...
#define PLAYBACK_VOLUME_CONTROL		(0)	// 1:enable volume control, 0:disable volume control	
...
// -------------------------------------------------------------------------------------------------------------------------------
#define WAKEUP_GPIO_TRIGGER			(0)		// Use GPIO to wake up chip
...
#define CONFIG_TRIGGER_KEY			(0)		// 1: enable trigger key, 0: disable trigger key
#define CONFIG_OUTPUT_PIN			(1)			// 1: enable output key, 0: disable output key
#define CONFIG_INPUT_STATE			(0)		// 1: enable input  state, 0: disable input  state
