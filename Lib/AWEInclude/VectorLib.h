 ...
 * @param[in] blockSize             Number of samples to process
 */
void awe_vecAllpassDelay16(INT16 * VEC_RESTRICT state,
							INT32	length,
							INT32 * write_index,
							INT32 * read_index,
							const FLOAT32 * VEC_RESTRICT src,
 ...
 * @param[in] dstinc    dest increment, distance between pairs of outputs
 * @param[in] nsamp     block size, number of samples to process
 */
void awe_vecAtan2uiNear(const FLOAT32* srcy, int srcyinc, const FLOAT32* srcx,
    int srcxinc, FLOAT32* dst, int dstinc, int nsamp);
 ...
 * @param[in] nsamp     block size, number of samples to process
 */
void awe_vecAtan2uiLinear(const FLOAT32* srcy, int srcyinc, const FLOAT32 *srcx,
    int srcxinc, FLOAT32 *dst, int dstinc, int nsamp);
...
extern FLOAT32 DecibelsToLinear_coeff[5];

extern FLOAT32 LinearToDecibels_coeff[5];
