...
#define PROCESSOR_TYPE_HEXAGON		22U
...
#define awe_modSetDeferredSet(S, v)			(S)->instance.packedFlags &= ~MODULE_GENERAL_DEFERRED_SET; (S)->instance.packedFlags |= ((v & 1U) << 27)
 ...
 */
UINT32 IpcPinBothBound(const IpcObject *pIpc);
 ...
 * @return								-1 on error
 */
INT32 IpcPinFlip(const IpcObject *pIpc);
 ...
 */
INT32 IpcPinWriteSourceSamples(const IpcObject *pIpc, UINT32 nSamples, Sample *pBuffer);
 ...
 * @return						-1 on error
 */
INT32 IpcPinSetupAsrc(IpcObject *pIpc, DSPC_ASRC_PROPS *props, INT32 sampleRateIn, INT32 sampleRateOut, INT32 phaseLen);
 ...
 */
UINT32 *awe_fwAddressOfMember(const AWEInstance *pAWE, UINT32 address, INT32 *retVal);
 ...
 * @return							pointer to member
 */
UINT32 *awe_fwAddressOfMember2(const AWEInstance *pAWE, UINT32 address, ModuleInstanceDescriptor **pMod, INT32 *retVal);
 ...
 */
INT32 awe_fwDerefPointer(const AWEInstance *pAWE, UINT32 address, INT32 *retVal);
 ...
 */
INT32 awe_fwSetPointer(const AWEInstance *pAWE, INT32 addressLhs, INT32 addressRhs, UINT32 offsRhs);
 ...
 * @return							0 or error code
 */
INT32 awe_fwSetInstanceID(const AWEInstance *pAWE, UINT32 moduleID, UINT32 newModuleID);
 ...
 */
INT32 awe_fwFetchValue(const AWEInstance *pAWE, UINT32 address, INT32 *retVal, UINT32 ptrOffset, UINT32 floatFlg);
 ...
 * @return							0 or error code
 */
INT32 awe_fwSetValue(const AWEInstance *pAWE, UINT32 address, INT32 value, UINT32 ptrOffset, UINT32 floatFlg);
 ...
 * @return							0 or error code
 */
INT32 awe_fwFetchValues(const AWEInstance *pAWE, UINT32 address, UINT32 offset, UINT32 argSize, Sample *args, UINT32 floatFlg);
 ...
 * @return							0 or error code
 */
INT32 awe_fwSetValues(const AWEInstance *pAWE, UINT32 address, UINT32 offset, UINT32 argCount, const Sample *args, UINT32 floatFlg);
 ...
 */
void awe_fwGetChannelCount(const AWEInstance *pAWE, UINT32 *inCount, UINT32 *outCount);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetHeapSize(const AWEInstance *pAWE, UINT32 *pHeaps);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetTargetInfo(const AWEInstance *pAWE, TargetInfo *pTarget);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetFirstObject2(const AWEInstance *pAWE, InstanceDescriptor **pObject, UINT32 *pClassID);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetNextObject(const InstanceDescriptor *currentObject, InstanceDescriptor **pObject, UINT32 *pClassID);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetFirstIO(const AWEInstance *pAWE, InstanceDescriptor **pObject, UINT32 *pClassID, FLOAT32 *sampleRate,
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetNextIO(const AWEInstance *pAWE, UINT32 pinID, InstanceDescriptor **pObject, UINT32 *pClassID, FLOAT32 *sampleRate,
	UINT32 *info1, UINT32 *info2, UINT32 *info3, UINT32 *name0, UINT32 *name1);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetWireType(const AWEInstance *pAWE, UINT32 wireID, UINT32 *pClassID, FLOAT32 *sampleRate, UINT32 *info1, UINT32 *info2, UINT32 *info3);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetPinType(const AWEInstance *pAWE, UINT32 pinID, UINT32 *pClassID, UINT32 *pBoundID, FLOAT32 *sampleRate,
	UINT32 *info1, UINT32 *info2, UINT32 *info3, UINT32 *name0, UINT32 *name1);
 ...
 */
InstanceDescriptor *GenericWire_Constructor(AWEInstance *pAWE, INT32 *retVal, FLOAT32 sampleRate, UINT32 info1, UINT32 info2, UINT32 info3, const ClassDescriptor *pClass);
 ...
 */
const ModClassModule *LookupModuleClass(const AWEInstance *pAWE, UINT32 classID);
 ...
 */
UINT32 awe_fwGetCIModuleCount(const AWEInstance *pAWE);
 ...
 * @return							0 or error code
 */
INT32 awe_fwGetCIModuleInfo(const AWEInstance *pAWE, UINT32 index, UINT32 *classID, UINT32 *packedParameters);
 ...
 */
INT32 awe_fwGetModuleState(const ModuleInstanceDescriptor *pModule);

/**
 * @brief Handle bound wir pointer adjustment.
 * @param [in] pAWE					AWE instance pointer (this)
 */
void awe_fwPrePump(const AWEInstance *pAWE);
 ...
 */
void awe_fwAudioInitIO(const AWEInstance *pAWE);
 ...
 *
 */
INT32 awe_fwAddModuleToLayout(const AWEInstance *pAWE, UINT32 argCount, const Sample *args);
 ...
 * @return							0 or error code
 */
void ClassLayout_Process(AWEInstance *pAWE, LayoutInstance *pLayout, UINT32 *pInstCycles, UINT32 *pTimePerProcess);
...
INT32 awe_fwSetCall2(const AWEInstance *pAWE, UINT32 moduleID, UINT32 mask);
...
INT32 awe_fwGetCall2(const AWEInstance *pAWE, UINT32 moduleID, UINT32 mask);
 ...
 * @return							0 or error code
*/
INT32 awe_fwGetProfileValues(const AWEInstance *pAWE, INT32 layoutNumber, UINT32 *pAverageCycles, UINT32 *pTimePerProcess);
 ...
 * @return							0 or error code
 */
INT32 awe_fwClearProfileValues(const AWEInstance *pAWE, INT32 layoutNumber);
 ...
 * @return							zero or error code
 */
INT32 awe_fwcreateLookupTable(AWEInstance *pAWE, UINT32 maxID);
 ...
 * @return							zero or error code
 */
void awe_fwSetIDPointer(const AWEInstance *pAWE, UINT32 id, InstanceDescriptor *pObject);
 ...
 */
void *awe_fwLookupID(const AWEInstance *pAWE, UINT32 id);
