...
//-----------------------------------------------------------------------------
INT32 awe_fwExecuteFile(AWEInstance *pAWE, UINT32 *pFileNameInDWords);
...
// PURPOSE: Fetch next command from file into sPacketBuffer
//-----------------------------------------------------------------------------
INT32 GetNextCommand(UINT32 *nTotalDWordsRead);

//-----------------------------------------------------------------------------
// METHOD:  awe_pltInitFileSystem
// PURPOSE: Initialize the file system
//-----------------------------------------------------------------------------
BOOL awe_pltInitFileSystem(void);
